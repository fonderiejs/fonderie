...
[`@fonderie/react-courier-admin`](https://github.com/fonderiejs/fonderie/tree/main/packages/react-courier-admin)
...
See [`@fonderie/react-config-admin-screens`](https://github.com/fonderiejs/fonderie/tree/main/packages/react-config-admin-screens).
