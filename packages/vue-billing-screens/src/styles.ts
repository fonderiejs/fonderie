...
export const styles: Record<string, CSSProperties> = {
	...
	section: { marginTop: '24px', paddingTop: '24px', borderTop: '1px solid #eee' },
	sectionTitle: { fontSize: '16px', fontWeight: 600, marginBottom: '8px' },
	cardLine: { fontSize: '14px', color: '#333', marginBottom: '12px' },
