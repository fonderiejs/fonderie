...
[`@fonderie/vue-courier-admin`](https://github.com/fonderiejs/fonderie/tree/main/packages/vue-courier-admin)
...
See [`@fonderie/vue-config-admin-screens`](https://github.com/fonderiejs/fonderie/tree/main/packages/vue-config-admin-screens).
