...
Thin bindings over [`@fonderie/client`](https://github.com/fonderie-js/sdk/tree/main/packages/client):
...
See [`@fonderie/react-auth-screens`](https://github.com/fonderie-js/sdk/tree/main/packages/react-auth-screens).
