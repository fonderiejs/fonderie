...
> **Status: in build — phase 7 of 8 (§9).** Phases 1–6 shipped (`@fonderie/core`
> 0.19.0, `@fonderie/admin` 0.5.0, `@fonderie/cli` 0.4.0). The census in §12 is what existed on
