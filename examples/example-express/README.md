...
A minimal Fonderie todo app built with **Express** — auth + a workspace-scoped todo
...
- `app.ts` — builds the Express app and `export default`s it (the Vercel entrypoint)
