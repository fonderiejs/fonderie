...
const DEFAULT_TEMPLATES: { "billing.subscription-canceled": { subject: string; html: string; text: string; }; "billing.payment-failed": { subject: string; html: string; text: string; }; "billing.trial-ending": { subject: string; html: string; text: string; }; "billing.renewal-receipt": { subject: string; html: string; text: string; }; "billing.limit-warning": { subject: string; html: string; text: string; }; "billing.limit-reached": { subject: string; html: string; text: string; }; "billing.credits-low": { subject: string; html: string; text: string; }; "billing.payment-receipt": { subject: string; html: string; text: string; }; "billing.refund-processed": { subject: string; html: string; text: string; }; "billing.auto-recharge-failed": { subject: string; html: string; text: string; }; }
